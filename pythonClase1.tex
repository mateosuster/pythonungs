...
\begin{itemize}
	...
	\item División: 5/2 $\to$ \pause 2. \alert{Ojo, por defecto es división entera}.\pause
...
\includegraphics[height=5.5cm]{spyder.png}
...
Probar lo siguiente:
\includegraphics[height=7.5cm]{consola1.png}
...
\begin{frame}{Usando la consola intérprete de Python (desde el Spyder)}
Probar lo siguiente:
\includegraphics[height=7.5cm]{consola2.png}
...
\includegraphics[height=7.5cm]{f2c.png}
